...
public class SingleDrugDoseAdjustmentAddGrid extends AgentGrid2D<SingleDrugDoseAdjustmentAddCell> {
    //model constants
    ...
    public static void main(String[] args) {
        ...
        SingleDrugDoseAdjustmentAddGrid[] models = new SingleDrugDoseAdjustmentAddGrid[4];
...
//            }
    ...
    public void ModelStep(int tick) {
        ...
        ShuffleAgents(rn);
        for (SingleDrugDoseAdjustmentAddCell cell : this) {
            cell.CellStep();
        }
...
//                drugLabel.SetText("Current Drug Metronomic is "+String.format("%.3f",CURRENT_DRUG)+"       Grid Avg is "+String.format("%.3f",drug.GetAvg()));
        ...
        for (int i = 0; i < length; i++) {
            SingleDrugDoseAdjustmentAddCell drawMe = GetAgent(i);
...
class SingleDrugDoseAdjustmentAddCell extends AgentSQ2Dunstackable<SingleDrugDoseAdjustmentAddGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        SingleDrugDoseAdjustmentAddCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                SingleDrugDoseAdjustmentAddCell tmpAgent = G.GetAgent(tmpAgentIndex);
