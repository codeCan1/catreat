...
public class SingleDrugWithDrugHolidayGrid extends AgentGrid2D<SingleDrugWithDrugHolidayCell> {
    //model constants
    ...
    public static void main(String[] args) {
        ...
        SingleDrugWithDrugHolidayGrid[] models = new SingleDrugWithDrugHolidayGrid[4];
...
//        FileIO popsOut=new FileIO("DrugHol2.csv","w");
...
//            }
    ...
    public void ModelStep(int tick) {
        ...
        ShuffleAgents(rn);
        for (SingleDrugWithDrugHolidayCell cell : this) {
            cell.CellStep();
        }
...
//                drugLabel.SetText("Current Drug Metronomic is "+String.format("%.3f",CURRENT_DRUG)+"       Grid Avg is "+String.format("%.3f",drug.GetAvg()));
        ...
        for (int i = 0; i < length; i++) {
            SingleDrugWithDrugHolidayCell drawMe = GetAgent(i);
...
class SingleDrugWithDrugHolidayCell extends AgentSQ2Dunstackable<SingleDrugWithDrugHolidayGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        SingleDrugWithDrugHolidayCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                SingleDrugWithDrugHolidayCell tmpAgent = G.GetAgent(tmpAgentIndex);
