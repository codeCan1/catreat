...
public class PpAlternatePenultimateDrugHolGrid extends AgentGrid2D<PpAlternatePenultimateDrugHolCell> {
    //model constants
    ...
    public static void main(String[] args) {
        ...
        PpAlternatePenultimateDrugHolGrid[] models = new PpAlternatePenultimateDrugHolGrid[4];
...
//        StandardTherapyChecker(tick);
        ...
        ShuffleAgents(rn);
        for (PpAlternatePenultimateDrugHolCell cell : this) {
            cell.CellStep();
        }
    }
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            PpAlternatePenultimateDrugHolCell drawMe = GetAgent(i);
...
class PpAlternatePenultimateDrugHolCell extends AgentSQ2Dunstackable<PpAlternatePenultimateDrugHolGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        PpAlternatePenultimateDrugHolCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                PpAlternatePenultimateDrugHolCell tmpAgent = G.GetAgent(tmpAgentIndex);
