...
public class CkIntermittentTherapyGrid extends AgentGrid2D<CkIntermittentTherapyCell> {
    //model constants
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public double Mut_DoublySen_to_DoublyRes = 0;
    ...
    public static void main(String[] args) {
        ...
        CkIntermittentTherapyGrid[] models = new CkIntermittentTherapyGrid[4];
        String strategy = "Int";
...
//
//        ShuffleAgents(rn);
//        for (CkIntermittentTherapyCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            CkIntermittentTherapyCell drawMe = GetAgent(i);
...
class CkIntermittentTherapyCell extends AgentSQ2Dunstackable<CkIntermittentTherapyGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        CkIntermittentTherapyCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                CkIntermittentTherapyCell tmpAgent = G.GetAgent(tmpAgentIndex);
