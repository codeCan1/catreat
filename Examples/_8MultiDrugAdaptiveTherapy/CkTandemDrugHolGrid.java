...
public class CkTandemDrugHolGrid extends AgentGrid2D<CkTandemDrugHolCell> {
    //model constants
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public static void main(String[] args) {
        ...
        CkTandemDrugHolGrid[] models = new CkTandemDrugHolGrid[4];
        String strategy = "DrugHol";
        String sub_strategy ="CkHiDrug";
        String file_counter ="LowTurnover1" ;
//        BufferedReader userInput=new BufferedReader(new InputStreamReader(System.in));
        ...
        double MTD_Reduction_Factor_DrugA=0.5;
        double MTD_Reduction_Factor_DrugB=0.5;
...
//
//        ShuffleAgents(rn);
//        for (CkTandemDrugHolCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            CkTandemDrugHolCell drawMe = GetAgent(i);
...
//        System.out.println("Tumor measurement after noise is " +CURRENT_POP);
        ...
        if(!HAS_AT_STARTED) {
            ...
            if(CURRENT_POP>=TUMOR_SIZE_TRIGGERING_AT) {
                ...
                System.out.println("Tick: "+tick+" Current Drug A and B for first dose and Current Pop "+CURRENT_POP+" >= Tumor size triggering AT is "+CURRENT_DRUG_A+" "+ CURRENT_DRUG_B+". Prev pop is "+PREV_POP);
                AT_START_TICK=tick;
...
class CkTandemDrugHolCell extends AgentSQ2Dunstackable<CkTandemDrugHolGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        CkTandemDrugHolCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                CkTandemDrugHolCell tmpAgent = G.GetAgent(tmpAgentIndex);
